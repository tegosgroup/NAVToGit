#
# Modulmanifest für das Modul "DynamicsNAVToGit"
#
# Generiert von: tegos GmbH
#
# Generiert am: 28.01.2020
#
...
GUID = 'f154010b-5799-4db5-9554-73b9e5cd2a3e'
...
FunctionsToExport = @('Export-FromNAVToGit','Import-FromGitToNAV','Set-ActiveNAVToGitConfiguration','Show-AvailableNAVVersions','Show-NAVToGitGui')
...
AliasesToExport = @('Export-FromNAVToGit','Import-FromGitToNAV','Set-ActiveNAVToGitConfiguration','Show-AvailableNAVVersions','Show-NAVToGitGui')
